    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-custom-green fixed-top shadow">
            <div class="container">
                ...
                <a class="navbar-brand text-white ms-auto me-0 fw-bold fs-4 text-uppercase" href="{{ route('admin.home') }}">SINILAI</a>
            </div>
        </nav>
        ...
        <div class="bg-custom-green text-white" id="sidebar-wrapper">
            <div class="p-3 d-flex flex-column h-100">
                ...
                <nav class="list-group list-group-flush flex-grow-1">
                    <a href="{{ route('admin.dashboard') }}" class="list-group-item list-group-item-action bg-custom-green text-white border-0 fw-medium border-menu">
                    ...
                    <div class="border-menu">
                        ...
                        <div class="collapse show" id="collapseMasterData">
                            <a href="{{ route('tahun-pelajaran.index') }}" class="list-group-item list-group-item-action bg-custom-green text-white border-0 ms-4 py-1">Tahun Pelajaran</a>
                            <a href="{{ route('kelas.index') }}" class="list-group-item list-group-item-action bg-custom-green text-white border-0 ms-4 py-1">Kelas</a>
                            <a href="{{ route('mapel.index') }}" class="list-group-item list-group-item-action bg-custom-green text-white border-0 ms-4 py-1">Mata Pelajaran</a>
                            <a href="{{ route('guru.index') }}" class="list-group-item list-group-item-action bg-custom-green text-white border-0 ms-4 py-1">Guru</a>
                            <a href="{{ route('siswa.index') }}" class="list-group-item list-group-item-action bg-custom-green text-white border-0 ms-4 py-1">Siswa</a>
                        </div>
                    </div>
                ...
                <div class="mt-auto border-top border-secondary pt-3">
                    <a href="{{ route('landing') }}" class="list-group-item list-group-item-action bg-danger text-white border-0 fw-medium rounded">
                ...
                <div class="p-5 shadow-sm rounded bg-white d-flex flex-column flex-md-row align-items-center justify-content-center" 
                    ...
                    <div class="me-md-5 mb-4 mb-md-0">
                        <div class="rounded-circle border border-secondary border-4 bg-white d-flex align-items-center justify-content-center" style="width: 192px; height: 192px;">
                            <img src="{{ asset('img/SD.png') }}" alt="Logo" class="img-fluid" style="width: 120%; height: 120%; object-fit: cover;">
                        </div>
                    </div>
                    
                    <div class="text-center text-md-start">
                        <p class="fs-4 fw-light text-black">Hi Admin, Welcome to</p>
