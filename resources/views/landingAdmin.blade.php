...
<div class="right-content">
    ...
    <form method="POST" action="{{ route('admin.login.submit') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-custom @error('id_admin') is-invalid @enderror" 
            id="id_admin" name="id_admin" placeholder="Masukkan ID Admin" required>
            @error('id_admin')
